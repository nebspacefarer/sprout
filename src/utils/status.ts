...
export const taskStatuses: Status[] = [
    { id: 0, title: "Triage", color: "#B8B8B8" },
    { id: 1, title: "Todo", color: "#B8B8B8" },
    { id: 2, title: "In Progress", color: "#5C6DDB" },
    { id: 3, title: "Stale", color: "#FCA465" },
    { id: 4, title: "Review Needed", color: "#ED82DE" },
    { id: 5, title: "Reviewed", color: "#82ED84" },
    { id: 6, title: "Done", color: "#549C6A" },
];
