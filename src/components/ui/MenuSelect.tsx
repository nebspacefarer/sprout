...
interface MenuSelectProps extends BaseHTMLAttributes<HTMLBaseElement> {
    menuTitle?: string | ComponentChildren;
    menuPlaceholder: string | ComponentChildren;
}
        ...
        <Menu.Root>
            ...
            <Menu.Portal>
                <Menu.Positioner className="outline-hidden" sideOffset={8}>
                    <Menu.Popup className="origin-[var(--transform-origin)] rounded-md bg-crust py-1 shadow-black/60 shadow-lg outline-1 outline-border transition-[transform,scale,opacity] data-[ending-style]:scale-90 data-[starting-style]:scale-90 data-[ending-style]:opacity-0 data-[starting-style]:opacity-0">
...
export function MenuSelectItem(props: MenuSelectItemProps) {
    return (
        <Menu.Item
            className={cn(
                "flex cursor-pointer select-none py-2 pr-8 pl-4 text-muted text-sm leading-4 outline-hidden data-[highlightedi]:relative data-[highlighted]:z-0 data-[disabled]:text-muted data-[highlighted]:text-foreground data-[disabled]:data-[highlighted]:before:bg-muted data-[highlighted]:before:absolute data-[highlighted]:before:inset-x-1 data-[highlighted]:before:inset-y-0 data-[highlighted]:before:z-[-1] data-[highlighted]:before:rounded-sm data-[highlighted]:before:bg-border",
                props.className,
            )}
